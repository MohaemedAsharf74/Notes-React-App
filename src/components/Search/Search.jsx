...
export default function Search() {
    ...
    return <>
        <h2 className="font-Montserrat h4 heading">
            <i className="bi bi-search me-2"></i>Search Notes
        </h2>
        {myNotes == null ? <div className="d-flex justify-content-center align-items-center"> <h2> Notes Empty </h2></div> : <div>{myNotes.msg !== "done" ? <div className="d-flex justify-content-center align-items-center"> <h2> Notes Empty </h2></div>
            : <div>
                <div className="row g-3 " >
                    <form action="" className="form-inline half mb-3 d-flex justify-content-center my-4" >
                        <input onChange={(e) => setsearch(e.target.value)} className="form-control mr-sm-2 w-50" type="search" placeholder="Search" aria-label="Search" autoFocus />
                    </form>
